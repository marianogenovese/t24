//-----------------------------------------------------------------------
// <copyright file="CreateRoleArgumentEnumerator.cs" company="Integra.Vision.Engine.Database">
...
namespace Integra.Vision.Engine.Commands
{
    ...
    /// <summary>
    /// Contains argument enumerator logic for Create Role command
    /// </summary>
    internal sealed class CreateRoleArgumentEnumerator : IArgumentEnumerator
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateRoleArgumentEnumerator"/> class
        /// </summary>
        /// <param name="node">Execution plan node that have the command arguments</param>
        public CreateRoleArgumentEnumerator(PlanNode node)
        {
            this.node = node;
        }
