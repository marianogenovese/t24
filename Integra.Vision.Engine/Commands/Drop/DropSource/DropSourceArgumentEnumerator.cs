//-----------------------------------------------------------------------
// <copyright file="DropSourceArgumentEnumerator.cs" company="Integra.Vision.Engine.Database">
...
namespace Integra.Vision.Engine.Commands
{
    ...
    /// <summary>
    /// Contains argument enumerator logic for Drop Source command
    /// </summary>
    internal sealed class DropSourceArgumentEnumerator : IArgumentEnumerator
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="DropSourceArgumentEnumerator"/> class
        /// </summary>
        /// <param name="node">Execution plan node that have the command arguments</param>
        public DropSourceArgumentEnumerator(PlanNode node)
        {
            this.node = node;
        }
