...
namespace Integra.Vision.Engine.Commands
{
    ...
    internal class DropSourceCommand : DropObjectCommandBase
    {
        ...
        public override CommandTypeEnum Type
        {
            get
            {
                return CommandTypeEnum.DropSource;
            }
        }
        ...
        protected override IArgumentEnumerator ArgumentEnumerator
        {
            get
            {
                ...
                {
                    this.argumentEnumerator = new DropSourceArgumentEnumerator(this.node);
                }
        ...
        protected override IDependencyEnumerator DependencyEnumerator
        {
            get
            {
                ...
                {
                    this.dependencyEnumerator = new DropSourceDependencyEnumerator(this.node);
                }
