//-----------------------------------------------------------------------
// <copyright file="DropStreamArgumentEnumerator.cs" company="Integra.Vision.Engine.Database">
...
namespace Integra.Vision.Engine.Commands
{
    ...
    /// <summary>
    /// Contains argument enumerator logic for Drop Stream command
    /// </summary>
    internal sealed class DropStreamArgumentEnumerator : IArgumentEnumerator
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="DropStreamArgumentEnumerator"/> class
        /// </summary>
        /// <param name="node">Execution plan node that have the command arguments</param>
        public DropStreamArgumentEnumerator(PlanNode node)
        {
            this.node = node;
        }
