//-----------------------------------------------------------------------
// <copyright file="DropAdapterArgumentEnumerator.cs" company="Integra.Vision.Engine.Database">
...
namespace Integra.Vision.Engine.Commands
{
    ...
    /// <summary>
    /// Contains argument enumerator logic for Drop Adapter command
    /// </summary>
    internal sealed class DropAdapterArgumentEnumerator : IArgumentEnumerator
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="DropAdapterArgumentEnumerator"/> class
        /// </summary>
        /// <param name="node">Execution plan node that have the command arguments</param>
        public DropAdapterArgumentEnumerator(PlanNode node)
        {
            this.node = node;
        }
