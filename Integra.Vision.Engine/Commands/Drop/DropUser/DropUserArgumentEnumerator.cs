//-----------------------------------------------------------------------
// <copyright file="DropUserArgumentEnumerator.cs" company="Integra.Vision.Engine.Database">
...
namespace Integra.Vision.Engine.Commands
{
    ...
    /// <summary>
    /// Contains argument enumerator logic for Drop User command
    /// </summary>
    internal sealed class DropUserArgumentEnumerator : IArgumentEnumerator
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="DropUserArgumentEnumerator"/> class
        /// </summary>
        /// <param name="node">Execution plan node that have the command arguments</param>
        public DropUserArgumentEnumerator(PlanNode node)
        {
            this.node = node;
        }
