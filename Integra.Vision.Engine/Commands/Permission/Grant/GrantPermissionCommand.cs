...
namespace Integra.Vision.Engine.Commands.Permission.Grant
{
    ...
    /// </summary>
    internal sealed class GrantPermissionCommand : PermissionCommandBase
    {
        /// <summary>
        /// Argument enumerator implementation for this command
        /// </summary>
        private IArgumentEnumerator argumentEnumerator = new GrantPermissionArgumentEnumerator();

        /// <summary>
        /// Dependency enumerator implementation for this command
        /// </summary>
        private IDependencyEnumerator dependencyEnumerator = new GrantPermissionDependencyEnumerator();
