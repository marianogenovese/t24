...
namespace Integra.Vision.Engine.Commands
{
    ...
    /// </summary>
    internal sealed class RevokePermissionCommand : CommandBase
    {
        /// <summary>
        /// Execution plan node
        /// </summary>
        ...
        /// </summary>
        public ObjectTypeEnum AssignableObjectType
        {
            get
            {
        ...
        /// </summary>
        public string AsignableObjectName
        {
            get
            {
        ...
        protected override IArgumentEnumerator ArgumentEnumerator
        {
            get
            {
                ...
                {
                    this.argumentEnumerator = new RevokePermissionArgumentEnumerator(this.node);
                }
        ...
        protected override IDependencyEnumerator DependencyEnumerator
        {
            get
            {
                ...
                {
                    this.dependencyEnumerator = new RevokePermissionDependencyEnumerator(this.node);
                }
