...
namespace Integra.Vision.Engine.Commands
{
    ...
    internal abstract class CreateObjectCommandBase : UserDefinedObjectCommandBase
    {
        ...
        public CreateObjectCommandBase(CommandTypeEnum commandType, string commandText, ISecurityContext securityContext) : base(commandType, commandText, securityContext)
        {
        }
    }
}