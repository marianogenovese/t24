...
namespace Integra.Vision.Engine.Commands
{
    ...
    internal abstract class DependencyValidationCommandBase : ArgumentValidationCommandBase
    {
        ...
        public DependencyValidationCommandBase(CommandTypeEnum commandType, string commandText, ISecurityContext securityContext) : base(commandType, commandText, securityContext)
        {
        }
    }
}
