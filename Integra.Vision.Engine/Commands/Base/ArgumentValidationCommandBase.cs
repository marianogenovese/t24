...
namespace Integra.Vision.Engine.Commands
{
    ...
    /// </summary>
    internal abstract class ArgumentValidationCommandBase : ExclusiveLockCommandBase
    {
        /// <summary>
        ...
        public ArgumentValidationCommandBase(CommandTypeEnum commandType, string commandText, ISecurityContext securityContext) : base(commandType, commandText, securityContext)
        {
        }
    }
}
