//-----------------------------------------------------------------------
// <copyright file="SingleElementOrderablePartitioner.cs" company="Integra.Vision.Engine">
...
namespace Integra.Vision.Engine.Core
{
    ...
    /// </summary>
    internal class SingleElementOrderablePartitioner<T> : OrderablePartitioner<T>
    {
