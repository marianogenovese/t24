//-----------------------------------------------------------------------
// <copyright file="SetTraceEngineCommandAction.cs" company="Ingetra.Vision.Engine">
...
namespace Integra.Vision.Engine.Core
{
    ...
    /// <summary>
    /// Implements all the process of set the trace level of a engine.
    /// </summary>
    internal sealed class SetTraceEngineCommandAction : ExecutionCommandAction
    {
        /// <summary>
        /// Set trace engine command
        /// </summary>
        private SetTraceEngineCommand command;

        /// <inheritdoc />
        protected override CommandActionResult OnExecuteCommand(CommandBase command)
        {
            this.command = command as SetTraceEngineCommand;
