//-----------------------------------------------------------------------
// <copyright file="SetTraceAdapterCommandAction.cs" company="Ingetra.Vision.Engine">
...
namespace Integra.Vision.Engine.Core
{
    ...
    /// <summary>
    /// Implements all the process of set the trace level of an adapter.
    /// </summary>
    internal sealed class SetTraceAdapterCommandAction : ExecutionCommandAction
    {
        /// <summary>
        /// Set trace adapter command
        /// </summary>
        private SetTraceAdapterCommand command;

        /// <inheritdoc />
        protected override CommandActionResult OnExecuteCommand(CommandBase command)
        {
            this.command = command as SetTraceAdapterCommand;
