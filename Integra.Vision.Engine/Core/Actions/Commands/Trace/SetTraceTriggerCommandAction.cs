//-----------------------------------------------------------------------
// <copyright file="SetTraceTriggerCommandAction.cs" company="Ingetra.Vision.Engine">
...
namespace Integra.Vision.Engine.Core
{
    ...
    /// <summary>
    /// Implements all the process of set the trace level of a trigger.
    /// </summary>
    internal sealed class SetTraceTriggerCommandAction : ExecutionCommandAction
    {
        /// <summary>
        /// Set trace trigger command
        /// </summary>
        private SetTraceTriggerCommand command;

        /// <inheritdoc />
        protected override CommandActionResult OnExecuteCommand(CommandBase command)
        {
            this.command = command as SetTraceTriggerCommand;
