//-----------------------------------------------------------------------
// <copyright file="SetTraceStreamCommandAction.cs" company="Ingetra.Vision.Engine">
...
namespace Integra.Vision.Engine.Core
{
    ...
    /// <summary>
    /// Implements all the process of set the trace level of a stream.
    /// </summary>
    internal sealed class SetTraceStreamCommandAction : ExecutionCommandAction
    {
        /// <summary>
        /// Set trace stream command
        /// </summary>
        private SetTraceStreamCommand command;

        /// <inheritdoc />
        protected override CommandActionResult OnExecuteCommand(CommandBase command)
        {
            this.command = command as SetTraceStreamCommand;
